...
def conv3d(signals, filters,
    ...
    _signals_shape_4d = (
        _signals_shape_5d[0] * _signals_shape_5d[1], #b
        _signals_shape_5d[2], #c
        _signals_shape_5d[3], #0
        _signals_shape_5d[4], #1
        )
    _filters_shape_4d = (
    ...
    if not fast_conv:
        ...
        input = signals.reshape(_signals_shape_4d)
        filters_ = filters.reshape(_filters_shape_4d)
        # # inputs have to be c01b
        ...
        # transformer = Conv2D(filters, 
        #         input_axes=('b','c',0,1), 
        #         output_axes=('b','c',0,1), 
        #         kernel_stride=(1, 1), 
        #         pad=0, 
        #         partial_sum=None)
        # out_4d = transformer.lmul(input)
